...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fz-ltr8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fz-ltr8.containers.anotherwebservice.com/
...
```
git clone git@github.com:hoangpq14736/container-fz-ltr8.git
cd container-fz-ltr8
```
...
```
docker attach container-fz-ltr8
```
